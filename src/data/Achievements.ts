...
import { DUNGEON_CRAWL_ACHIEVEMENTS } from '@/data/dungeonCrawlAchievements';
...
export const ACHIEVEMENTS: Achievement[] = [
      ...
      // ===== Dungeon Crawl Achievements (src/data/dungeonCrawlAchievements.ts) =====
      ...DUNGEON_CRAWL_ACHIEVEMENTS,
